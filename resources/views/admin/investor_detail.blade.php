        ...
        <div class="container mb-5 mt-3">
            ...
            <div class="container">
                    ...
                    <table class="table table-striped table-borderless ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <img src="{{asset('dashboard/user/images/'.$investor->frontImage)}}"
                                        style="width: 120px;" />
                                </td>
                                <td>
                                    <img src="{{asset('dashboard/user/images/'.$investor->backImage)}}"
                                        style="width: 120px;" />
                                </td>
                                <td>
                                    <img src="{{asset('dashboard/user/images/'.$investor->selfie)}}"
                                        style="width: 120px;" />
                                </td>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class=" text-center">
                            <button class="btn btn-info" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#addFunds">
                                Add Balance
                            </button>
                            <button class="btn btn-outline-info" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#subFunds">
                                Remove Balance
                            </button>
                            <button class="btn btn-primary" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#addProfit">
                                Add Profit
                            </button>
                            <button class="btn btn-outline-primary" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#subProfit">
                                Remove Profit
                            </button>
                            <button class="btn btn-success" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#addRef">
                                Add Referral Balance
                            </button>
                            <button class="btn btn-outline-success" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#subRef">
                                Remove Referral Balance
                            </button>
                            <button class="btn btn-warning" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#addWith">
                                Add Withdrawal
                            </button>
                            <button class="btn btn-outline-warning" style="margin-bottom:4px;" data-toggle="modal"
                                data-target="#subWith">
                                Remove Withdrawal
                            </button>
...
<div class="modal fade" id="subRef" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="addWith" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="subWith" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="subLoan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
