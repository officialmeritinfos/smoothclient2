            ...
            <div class="card-body p-5">
                ...
                <form class="row g-3" method="post" action="{{route('investment.new')}}">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select type="number" class="form-control form-control-lg" id="inputAddress2" name="package">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <select type="number" class="form-control form-control-lg" id="inputAddress2" name="asset">
                    ...
                    <div class="form-group col-md-12 mx-auto">
                        ...
                        <select type="number" class="form-control form-control-lg" id="inputAddress2" name="account">
                            <option value="">Select a Account</option>
                            <option value="1">Account Balance</option>
                            @if($user->canCompound==1)
                            <option value="2">Reinvest from Total Profit</option>
                            @endif
                        </select>
                    </div>
